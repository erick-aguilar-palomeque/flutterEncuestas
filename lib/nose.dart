...
// class EncuestaState extends StatefulWidget {
//   EncuestaState({Key? key, this.title = ""}) : super(key: key);
//   final String title;
//   @override
//   Encuestas createState() => new Encuestas();
// }

// class Encuestas extends State<EncuestaState> {
//   @override
//   Widget build(BuildContext context) {
//     return Scaffold(
//       appBar: AppBar(
...
//       body: Container(padding: EdgeInsets.all(30.0), child: new SignUpForm()),
//     );
//   }
// }
